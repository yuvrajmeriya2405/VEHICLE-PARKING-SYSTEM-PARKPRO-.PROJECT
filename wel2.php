...
<div class="main-container">
	<div class="row clearfix progress-box">
		<div class="col-lg-3 col-md-6 col-sm-12 mb-30">
			<div class="card-box pd-30 height-100-p" style="box-shadow: 0px 0px 10px rgba(0,0,0,.5)">
		...
		$timestamp = time();
		$currentDate = gmdate('Y-m-d', $timestamp);
		$sql = "select COUNT(cu_id) as 'outcuscount' from parking_customer where v_status='in' and v_indate_time>='DATE_SUB(NOW(), INTERVAL 30 DAY)'";
		$res = mysqli_query($con, $sql);
		$row = mysqli_fetch_assoc($res);
	...
	<div class="row">
		<div class="col-lg-3 col-md-6 col-sm-10 mb-30">
			<div class="card-box pd-30 pt-15 height-50-p" style="box-shadow: 0px 0px 10px rgba(0,0,0,.5)">
		...
		<div class="col-lg-3 col-md-6 col-sm-12 mb-30">
			<div class="card-box pd-30 height-100-p" style="box-shadow: 0px 0px 10px rgba(0,0,0,.5)">
				...
				<br>
				<span>
					<h1 style="text-align: center; color: #02CCFE">₹5</h1>
				</span>
				<br>
				<br>
				<br>
    ...
    <div class="card-box pd-30 height-100-p">
        ...
        <br>
        <span>
            <h1 style="text-align: center; color:#f56767;">
                <?php 
